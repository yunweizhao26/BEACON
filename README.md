...
Paths are set up to run from `beacon/` and use local datasets in `data/raws` and `data/processed`. Intermediate split data (train/valid/test) are stored at `data/splits`.

See [DATA.md](DATA.md) for benchmark data provenance and source links.
